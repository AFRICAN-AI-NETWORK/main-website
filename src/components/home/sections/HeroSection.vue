<template>
  <section id="hero"
    class="lg:min-h-screen flex flex-col justify-between lg:flex-row gap-x-5 px-14 pt-[120px] lg:px-20 pb-0 bg-cover bg-[url('/src/assets/hero-bg.jpg')] text-white">
    ...
    <img src="@/assets/futuristic-robot.svg" class="mt-auto xl:max-w-none 2xl:min-h-[50em]" alt="">
  </section>
</template>